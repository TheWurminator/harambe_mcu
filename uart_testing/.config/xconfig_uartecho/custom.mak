...
linker.cmd: package/cfg/uartecho_pem3.xdl
	$(SED) 's"^\"\(package/cfg/uartecho_pem3cfg.cmd\)\"$""\"C:/Users/BeetleJuice/Desktop/harambe_mcu/ohman_shittyuart/.config/xconfig_uartecho/\1\""' package/cfg/uartecho_pem3.xdl > $@
